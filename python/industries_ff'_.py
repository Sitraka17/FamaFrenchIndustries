...
Author:     SITRAKA FORLER (lux-aiops.com)
            ...
            Ed deHaan, derived from work of unknown authors
            Xue Li updated on 3/24/2021

Purpose:    To assign Fama-French 48 industry codes based on 4-digit SIC codes

Version:    1.0 - Python translation - 10/26/2025

Notes:      48 Industry classification codes obtained from French's website
            http://mba.tuck.dartmouth.edu/pages/faculty/ken.french/data_library.html
            
            Original SAS macro versions:
            1.0 - 7/21/10 - original version
            1.1 - 11/19/10 - redid all codes based on updated FF classification
            1.2 - 03/24/21 - added classifications for SIC codes 900 (Fishing, 
...
def assign_ff48_industry(df, sic_col='sic', prefix='i', ind_code_col='FF_IND_CODE'):
    """
    Assign Fama-French 48-industry codes to a DataFrame using SIC codes.
    
    Adds to the DataFrame:
        - ind_code_col: integer industry code (1-48)
        - 'FF_IND': textual industry name
        - 48 one-hot encoded columns (prefix1, prefix2, ..., prefix48)
    
    Parameters:
        df: pandas DataFrame with SIC codes
        sic_col: column name for SIC code (must be 4-digit integer or NaN)
        prefix: prefix for 48 binary columns ('i' → i1, i2, ..., i48)
    ...
    def get_ff48_code(sic):
        if pd.isnull(sic):
            return np.nan
        sic = int(sic)
        
        # Industry mappings based on SIC ranges
        sic_ranges = {
            1: [(100, 199), (200, 299), (700, 799), (900, 900), (910, 919), (2048, 2048)],
            2: [(2000, 2009), (2010, 2019), (2020, 2029), (2030, 2039), (2040, 2046), 
                (2050, 2059), (2060, 2063), (2070, 2079), (2090, 2092), (2095, 2095), (2098, 2099)],
            3: [(2064, 2068), (2086, 2086), (2087, 2087), (2096, 2096), (2097, 2097)],
            4: [(2080, 2080), (2082, 2082), (2083, 2083), (2084, 2084), (2085, 2085)],
            5: [(2100, 2199)],
            6: [(920, 999), (3650, 3651), (3652, 3652), (3732, 3732), (3930, 3931), (3940, 3949)],
            7: [(7800, 7829), (7830, 7833), (7840, 7841), (7900, 7900), (7910, 7911), 
                (7920, 7929), (7930, 7933), (7940, 7949), (7980, 7980), (7990, 7999)],
            8: [(2700, 2709), (2710, 2719), (2720, 2729), (2730, 2739), (2740, 2749), 
                (2770, 2771), (2780, 2789), (2790, 2799)],
            9: [(2047, 2047), (2391, 2392), (2510, 2519), (2590, 2599), (2840, 2843), 
                ...
                (3910, 3911), (3914, 3914), (3915, 3915), (3960, 3962), (3990, 3990), 
                (3991, 3991), (3995, 3995)],
            10: [(2300, 2390), (3020, 3021), (3100, 3111), (3130, 3131), (3140, 3149), 
                 (3150, 3151), (3963, 3965)],
            11: [(8000, 8099)],
            12: [(3693, 3693), (3840, 3849), (3850, 3851)],
            13: [(2830, 2830), (2831, 2831), (2833, 2833), (2834, 2834), (2835, 2835), (2836, 2836)],
            14: [(2800, 2809), (2810, 2819), (2820, 2829), (2850, 2859), (2860, 2869), 
                 (3665, 3665), (3666, 3666), (3669, 3669), (3670, 3679), (3810, 3810), (3812, 3812)],
            37: [(3811, 3811), (3820, 3820), (3821, 3821), (3822, 3822), (3823, 3823), 
                 (3824, 3824), (3825, 3825), (3826, 3826), (3827, 3827), (3829, 3829), (3830, 3839)],
            38: [(2520, 2549), (2600, 2639), (2670, 2699), (2760, 2761), (3950, 3955)],
            39: [(2440, 2449), (2640, 2659), (3220, 3221), (3410, 3412)],
            40: [(4000, 4013), (4040, 4049), (4100, 4100), (4110, 4119), (4120, 4121), 
            ...
            41: [(5000, 5000), (5010, 5015), (5020, 5023), (5030, 5039), (5040, 5042), 
                 ...
                 (5140, 5149), (5150, 5159), (5160, 5169), (5170, 5172), (5180, 5182), (5190, 5199)],
            42: [(5200, 5200), (5210, 5219), (5220, 5229), (5230, 5231), (5250, 5251), 
            ...
            43: [(5800, 5819), (5820, 5829), (5890, 5899), (7000, 7000), (7010, 7019), 
                 (7040, 7049), (7213, 7213)],
            44: [(6000, 6000), (6010, 6019), (6020, 6020), (6021, 6021), (6022, 6022), 
            ...
            45: [(6300, 6300), (6310, 6319), (6320, 6329), (6330, 6331), (6350, 6351), 
                 (6360, 6361), (6370, 6379), (6390, 6399), (6400, 6411)],
            46: [(6500, 6500), (6510, 6510), (6512, 6512), (6513, 6513), (6514, 6514), 
                 (6515, 6515), (6517, 6519), (6520, 6529), (6530, 6531), (6532, 6532), 
                 (6540, 6541), (6550, 6553), (6590, 6599), (6610, 6611)],
            47: [(6200, 6299), (6700, 6700), (6710, 6719), (6720, 6722), (6723, 6723), 
                 (6724, 6724), (6725, 6725), (6726, 6726), (6730, 6733), (6740, 6779), 
                 (6790, 6791), (6792, 6792), (6793, 6793), (6794, 6794), (6795, 6795), 
                 (6797, 6797), (6798, 6798), (6799, 6799)],
            48: [(4950, 4959), (4960, 4961), (4970, 4971), (4990, 4991), (9990, 9999)],
        }
        
        # Check which industry the SIC belongs to
    ...
    df[ind_code_col] = df[sic_col].apply(get_ff48_code)
    
    # Assign textual name
    df['FF_IND'] = df[ind_code_col].map(FF48_NAMES)

    # Add 48 binary columns (one-hot encoding)
    for i in range(1, 49):
        col = f'{prefix}{i}'
...
if __name__ == "__main__":
    ...
    df = pd.DataFrame({
        'sic': [900, 1311, 2050, 2834, 3571, 3990, 4820, 5001, 6021, 6797, 
                7372, 8001, 9100, 4950, None]
    })

    # Assign Fama-French codes
    df_ff48 = assign_ff48_industry(df, sic_col='sic', prefix='i', ind_code_col='FF_IND_CODE')

    print(df_ff48[['sic', 'FF_IND_CODE', 'FF_IND']])
    
    # To get list of all industry dummy columns
    industry_fe_columns = [f'i{i}' for i in range(1, 49)]
    print(f"\nIndustry FE columns ({len(industry_fe_columns)} total):")
    print(' '.join(industry_fe_columns))
